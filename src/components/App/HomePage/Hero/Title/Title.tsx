...
import ArtTitle from '@/components/App/HomePage/Hero/Title/Art'
import DesignTitle from '@/components/App/HomePage/Hero/Title/Design'
import DevTitle from '@/components/App/HomePage/Hero/Title/Dev'
