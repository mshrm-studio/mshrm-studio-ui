...
import EthAddress from '@/app/[lang]/_components/EthAddress'
...
export default function HomePageHeroAuthOptions() {
    ...
    return (
        <div className={styles.authOptions}>
            <div
                className={clsx(styles.authOption, styles.microsoftAuthOption)}
            >
                {isAuthenticated ? (
            ...
            <div className={clsx(styles.authOption, styles.cryptoAuthOption)}>
