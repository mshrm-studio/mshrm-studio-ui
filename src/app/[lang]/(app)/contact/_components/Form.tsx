...
import Input from '@/app/[lang]/(app)/_components/Input/Input'
import InputFile from '@/app/[lang]/(app)/_components/Input/File'
import Textarea from '@/app/[lang]/(app)/_components/Textarea'
import styles from '@/app/[lang]/(app)/contact/_styles/form.module.css'
